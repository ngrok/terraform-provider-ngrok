...
type Tunnel struct {
	...
	// (/ngrok-agent/config#common-tunnel-configuration-properties) In API version 0,
	// this value was instead pulled from the top-level metadata configuration option
	// (/ngrok-agent/config#metadata).
	Metadata string `json:"metadata,omitempty"`
