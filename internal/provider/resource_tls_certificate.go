...
func (r *tlsCertificateResource) Schema(ctx context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	...
	addStringPlanModifiers(attrs, "certificate_pem", whitespaceInsensitiveString(), requiresReplaceString())
	addStringPlanModifiers(attrs, "private_key_pem", whitespaceInsensitiveString(), requiresReplaceString())
