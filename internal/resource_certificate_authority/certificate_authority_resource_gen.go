...
package resource_certificate_authority
...
func CertificateAuthorityResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"id": schema.StringAttribute{
				...
				MarkdownDescription: "unique identifier for this Certificate Authority\n",
			},
